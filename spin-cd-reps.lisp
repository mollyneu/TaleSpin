    ...
    (t (doit (propel p1 obj p2 p1))
	 ...
	 ((and (> n 2)
	  ...
	  (cond  ((is-true? (state obj 'bursted 'pos))
		  ...
		  (assert-fact
		    (mloc 'world
			  (results-in (play p1 obj) (happy p1))
			  )))
		 ;; otherwise, pick up the object and play more catch.
		 (t (doit (grasp p2 obj))
		    (play-catch p2 p1 obj (+ n 1)))))
	 ;; otherwise, play mmore catch (throw it back).
...
;;; Action X results in state Y. [cox 12feb95]
